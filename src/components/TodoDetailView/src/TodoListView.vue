<template>
  <div class="todolist">
    <todo-list title="今日之前" :todoList="todo.subTodoList | beforeToday" :defaultExpanded="true"></todo-list>
    <todo-list title="今日待办" :todoList="todo.subTodoList | today" :defaultExpanded="true"></todo-list>
